...
| :--- | :--- | :--- |
| b241202044 | Beyzanur Kacır | Technical Architecture, UI/UX Design, Front-end Logic (JavaScript), Bootstrap |
...
* **Logic Engine:** * The *Roast Algorithm* checks for specific keyword combinations in the user's top genres (e.g., matching "sad indie" with specific roast templates).
  * The *Personality Algorithm* calculates a dominant trait based on the aggregation of the most listened genres and outputs a matching profile.
...
## Technology Stack
* **Frontend:** HTML5 , Bootstrap 5 (Responsive Layout), CSS3 , JavaScript (ES6+).
* **API:** Spotify Web API.
